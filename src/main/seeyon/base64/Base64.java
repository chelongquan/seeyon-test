 ...
 * @since 1.0-dev
 * @version $Id: Base64.java,v 1.1 2011/02/26 09:10:50 tanmf Exp $
 */
public class Base64 {
    ...
    public static String encodeString(byte[] pArray) throws UnsupportedEncodingException{
    	return new String(encode(pArray),ENCODING);
    }
    public static String encodeString(String pArray) throws UnsupportedEncodingException{
        return new String(encode(pArray.getBytes(ENCODING)),ENCODING);
    }
}
